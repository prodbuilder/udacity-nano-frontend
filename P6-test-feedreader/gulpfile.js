...
var paths = {
    ...
    stylesheets: ['css/*.css','scss/style.scss','scss/styles/*.scss'],
    images: ['image/**/*'],
...
gulp.task('serve', ['scripts', 'styles','images', 'fonts', 'svgstore', 'content', 'browse']);





// TODO: this bottom part is the only part that works
